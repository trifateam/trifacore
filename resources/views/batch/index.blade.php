...
@section('content')
    ...
    <x-page-header title="Data Batch Aktif" subtitle="Kelola seluruh data batch yang sedang aktif di kandang produksi" />
                ...
                <x-table>
                    <x-slot:thead>
                        <tr>
                            ...
                            <th class="px-6 py-3 bg-gray-50 dark:bg-gray-700/50 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Tgl Afkir</th>
                        ...
                        @forelse($batches as $batch)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $batch->nama_batch }}</div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-900 dark:text-gray-100">
                                    {{ $batch->tgl_afkir ? \Carbon\Carbon::parse($batch->tgl_afkir)->translatedFormat('d M Y') : '-' }}
                                </td>
