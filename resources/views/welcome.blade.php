...
<head>
    ...
    <meta name="description" content="TrifaFarm">
    <title>TrifaFarm</title>
...
<body class="bg-white dark:bg-[#0f0f0f] text-gray-900 dark:text-gray-100 overflow-x-hidden">
    ...
    <div x-show="loading" x-transition:leave="transition ease-in duration-500" x-transition:leave-start="opacity-100"
        ...
        <div class="relative mb-6">
            <div class="w-16 h-16 rounded-full border-4 border-[#FFC72C]/20 border-t-[#FFC72C]"
                style="animation: loading-spin 1s linear infinite;"></div>
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-500"
        :class="scrolled ? 'lp-glass shadow-lg shadow-black/5 dark:shadow-black/20' : 'bg-transparent'" id="navbar">
            ...
            <div class="flex items-center justify-between h-18 md:h-20">
                ...
                <a href="#beranda" class="flex items-center gap-2 group" @click.prevent="scrollToSection('beranda')">
                    <img src="{{ asset('images/trifaFarmRedesign.png') }}"
                        class="h-11 md:h-12 w-auto object-contain drop-shadow-lg" alt="Trifafarm Logo">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button @click="toggleDark()"
                        class="relative w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 hover:bg-gray-100 dark:hover:bg-white/10"
                    ...
                    <a href="{{ route('login') }}"
                        class="hidden md:inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold rounded-xl bg-[#FFC72C] text-white hover:bg-[#FFB800] transition-all duration-300 hover:shadow-lg hover:shadow-[#FFC72C]/25">
                    ...
                    <button @click="mobileMenuOpen = !mobileMenuOpen"
                        class="md:hidden w-10 h-10 rounded-xl flex items-center justify-center hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
        ...
        <div x-show="mobileMenuOpen" x-cloak x-transition:enter="transition ease-out duration-300"
            ...
            <div class="p-4 space-y-1">
                <template x-for="item in menuItems" :key="item.id">
                    <a :href="'#' + item.id" @click.prevent="scrollToSection(item.id); mobileMenuOpen = false"
                ...
                <a href="{{ route('login') }}"
                    class="flex items-center gap-2 px-4 py-3 text-sm font-semibold text-[#FFC72C] rounded-xl hover:bg-[#FFC72C]/10 transition-colors">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
    ...
    <section id="beranda" class="relative min-h-screen flex items-center overflow-hidden pt-20">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <div
                class="absolute -top-40 -right-40 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-[#FFC72C]/20 to-[#FF9500]/10 lp-blob-1 blur-3xl">
            </div>
            <div
                class="absolute -bottom-60 -left-40 w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-[#FFC72C]/15 to-[#FFE082]/10 lp-blob-2 blur-3xl">
            </div>
            <div class="absolute top-1/3 left-1/2 w-[300px] h-[300px] rounded-full bg-[#FFC72C]/5 lp-blob-1 blur-2xl">
            </div>
            {{-- Subtle grid pattern --}}
            <div class="absolute inset-0 opacity-[0.02] dark:opacity-[0.04]"
                style="background-image: radial-gradient(circle, #FFC72C 1px, transparent 1px); background-size: 40px 40px;">
            </div>
        </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <p class="text-lg text-gray-500 dark:text-gray-400 mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed"
                        ...
                        Trifafarm menghadirkan telur ayam segar berkualitas premium, ayam afkir siap olah, dan pupuk
                        kandang organik hasil dari peternakan modern kami di Padang.
                    </p>
                ...
                <div class="relative flex items-center justify-center"
                    ...
                    <div class="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div
                                class="w-48 h-48 sm:w-56 sm:h-56 lg:w-64 lg:h-64 rounded-full bg-gradient-to-br from-[#FFC72C]/20 to-[#FFE082]/30 dark:from-[#FFC72C]/10 dark:to-[#FFE082]/15 flex items-center justify-center lp-float-slow shadow-2xl shadow-[#FFC72C]/10">
                                <svg class="w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 text-[#FFC72C] drop-shadow-lg"
                                    viewBox="0 0 100 120" fill="currentColor">
                        ...
                        <div class="absolute top-4 right-4 lp-float" style="animation-delay: 0.5s;">
                            <div
                                class="bg-white dark:bg-gray-800 rounded-2xl p-3 shadow-xl shadow-black/5 dark:shadow-black/30 flex items-center gap-2">
                                <div
                                    class="w-8 h-8 rounded-xl bg-green-100 dark:bg-green-900/30 flex items-center justify-center">
                        ...
                        <div class="absolute top-1/2 -left-4 lp-float" style="animation-delay: 1.5s;">
                            <div
                                class="bg-white dark:bg-gray-800 rounded-2xl px-3 py-2 shadow-xl shadow-black/5 dark:shadow-black/30">
    ...
    <section id="produk" class="py-20 md:py-28 bg-[#F5F5F5] dark:bg-[#1a1a1a] relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16 lp-animate" x-intersect:enter.once="$el.classList.add('visible')">
                <span
                    class="inline-block px-4 py-1.5 rounded-full bg-[#FFC72C]/10 text-[#FFC72C] text-sm font-semibold mb-4">Produk
                    Kami</span>
                ...
                <p class="text-gray-500 dark:text-gray-400 max-w-2xl mx-auto text-lg">
                    Diproses dengan standar kebersihan tertinggi dan disajikan segar untuk memenuhi berbagai kebutuhan
                    pangan dan pertanian Anda.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
                ...
                @foreach($cards as $index => $c)
                    ...
                    <div class="lp-card lp-animate bg-white dark:bg-[#222] p-5 shadow-sm border border-gray-100 dark:border-gray-800 group flex flex-col"
                        ...
                        <div
                            class="w-full h-36 rounded-2xl overflow-hidden mb-4 bg-white dark:bg-white flex items-center justify-center border border-gray-100 dark:border-gray-800">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="text-xl font-extrabold text-[#FFC72C]">{{ $stok }} <span
                                    class="text-sm font-medium text-gray-500">{{ $item ? $item->satuan : '' }}</span></div>
                        </div>

                        <a href="https://wa.me/6281372237463?text=Halo%20Trifafarm,%20saya%20ingin%20memesan%20{{ rawurlencode($c['name']) }}"
                            target="_blank"
    ...
    <section id="tentang" class="py-20 md:py-28 bg-white dark:bg-[#0f0f0f] relative overflow-hidden">
        ...
        <div
            class="absolute top-20 right-0 w-[500px] h-[500px] rounded-full bg-[#FFC72C]/5 lp-blob-2 blur-3xl pointer-events-none">
        </div>
        <div
            class="absolute bottom-0 left-0 w-[300px] h-[300px] rounded-full bg-[#FFC72C]/3 lp-blob-1 blur-3xl pointer-events-none">
        </div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16 lp-animate" x-intersect:enter.once="$el.classList.add('visible')">
                <span
                    class="inline-block px-4 py-1.5 rounded-full bg-[#FFC72C]/10 text-[#FFC72C] text-sm font-semibold mb-4">Tentang
                    Kami</span>
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4">
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="lp-animate" x-intersect:enter.once="$el.classList.add('visible')">
                    <div
                        class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#FFC72C]/10 border border-[#FFC72C]/20 mb-6">
                        <svg class="w-4 h-4 text-[#FFC72C]" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                        <p>
                            <strong class="text-gray-900 dark:text-gray-100">Trifafarm</strong> berdiri pada tahun 2020
                            di kawasan Limau Manis, Kecamatan Pauh, Kota Padang, Sumatera Barat. Bermula dari tekad tiga
                            bersaudara yang ingin memanfaatkan lahan keluarga secara produktif, peternakan ini lahir
                            dengan modal terbatas namun semangat yang besar.
                        </p>
                        <p>
                            Pada awal berdirinya, Trifafarm hanya memiliki satu kandang dengan kapasitas 500 ekor ayam
                            petelur. Telur-telur segar kami dipasarkan langsung ke warung dan pasar tradisional di
                            sekitar Pauh dan Limau Manis, membangun kepercayaan pelanggan satu per satu.
                        </p>
                        <p>
                            Seiring waktu, permintaan terus meningkat. Pada tahun 2022, kami memperluas kapasitas
                            kandang dan mulai mengolah kotoran ayam menjadi <strong
                                class="text-gray-900 dark:text-gray-100">pupuk kandang organik</strong> yang kini
                            menjadi produk unggulan kami bagi para petani sayur di sekitar Padang.
                        </p>
                        <p>
                            Pada 2023, Trifafarm bertransisi ke sistem kandang semi-modern dan mengintegrasikan sistem
                            manajemen digital <strong class="text-gray-900 dark:text-gray-100">Trifacore</strong> —
                            memungkinkan pemantauan produksi telur, kesehatan ternak, dan stok pakan secara real-time
                            untuk menjaga kualitas di setiap butir telur.
                        </p>
                    </div>
                    ...
                    <div class="mt-8 flex flex-wrap gap-4">
                        <div
                            ...
                            <span
                                class="text-xs font-medium text-gray-600 dark:text-gray-400">Tahun<br>Pengalaman</span>
                        </div>
                        <div
                            class="flex items-center gap-2 px-4 py-3 rounded-2xl bg-[#FFC72C]/10 border border-[#FFC72C]/20">
                            <span class="text-2xl font-extrabold text-[#FFC72C]">5K+</span>
                            <span class="text-xs font-medium text-gray-600 dark:text-gray-400">Ekor
                                Ayam<br>Petelur</span>
                        </div>
                        <div
                            class="flex items-center gap-2 px-4 py-3 rounded-2xl bg-[#FFC72C]/10 border border-[#FFC72C]/20">
                ...
                <div class="lp-animate lp-animate-delay-1" x-intersect:enter.once="$el.classList.add('visible')">
                    <div class="relative pl-8">
                        {{-- Vertical line --}}
                        <div
                            class="absolute left-3.5 top-2 bottom-2 w-0.5 bg-gradient-to-b from-[#FFC72C] via-[#FFC72C]/50 to-transparent">
                        </div>

                        {{-- Milestone 1 --}}
                        <div class="relative mb-10">
                            <div
                                class="absolute -left-8 top-1 w-7 h-7 rounded-full bg-[#FFC72C] flex items-center justify-center shadow-lg shadow-[#FFC72C]/30">
                            ...
                            <div
                                class="lp-card bg-white dark:bg-[#1a1a1a] p-5 border border-gray-100 dark:border-gray-800 shadow-sm">
                                <span class="text-xs font-bold text-[#FFC72C] uppercase tracking-wider">2020 — Awal
                                    Berdiri</span>
                                <h4 class="font-bold text-base mt-1 mb-2">Kandang Pertama Trifafarm</h4>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Memulai dengan 500 ekor ayam petelur
                                    di lahan keluarga, Limau Manis, Padang. Produk dipasarkan ke warung lokal.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative mb-10">
                            ...
                            <div
                                class="lp-card bg-white dark:bg-[#1a1a1a] p-5 border border-gray-100 dark:border-gray-800 shadow-sm">
                                <span class="text-xs font-bold text-[#FFC72C] uppercase tracking-wider">2022 — Ekspansi
                                    Produk</span>
                                <h4 class="font-bold text-base mt-1 mb-2">Pupuk Kandang & Ayam Afkir</h4>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Kapasitas kandang diperluas. Kotoran
                                    ayam diolah menjadi pupuk kandang organik. Ayam afkir mulai dipasarkan ke pelanggan
                                    kuliner.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative mb-10">
                            ...
                            <div
                                class="lp-card bg-white dark:bg-[#1a1a1a] p-5 border border-gray-100 dark:border-gray-800 shadow-sm">
                                <span class="text-xs font-bold text-[#FFC72C] uppercase tracking-wider">2023 —
                                    Modernisasi</span>
                                <h4 class="font-bold text-base mt-1 mb-2">Sistem Manajemen Digital Trifacore</h4>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Transisi ke kandang semi-modern dan
                                    integrasi sistem digital Trifacore untuk pencatatan produksi, pakan, dan kesehatan
                                    ternak secara real-time.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            <div
                                class="absolute -left-8 top-1 w-7 h-7 rounded-full bg-gradient-to-br from-[#FFC72C] to-[#FF9500] flex items-center justify-center shadow-lg shadow-[#FFC72C]/40 animate-pulse">
                            ...
                            <div
                                class="lp-card bg-gradient-to-br from-[#FFC72C]/10 to-[#FFE082]/10 dark:from-[#FFC72C]/5 dark:to-[#FFE082]/5 p-5 border border-[#FFC72C]/30 shadow-sm">
    ...
    <section id="testimoni" class="py-20 md:py-28 bg-[#F5F5F5] dark:bg-[#1a1a1a] relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16 lp-animate" x-intersect:enter.once="$el.classList.add('visible')">
                <span
                    class="inline-block px-4 py-1.5 rounded-full bg-[#FFC72C]/10 text-[#FFC72C] text-sm font-semibold mb-4">Testimoni</span>
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4">
            ...
            {{-- Carousel --}}
            <div class="lp-animate" x-intersect:enter.once="$el.classList.add('visible')" x-data="testimonialCarousel()"
                ...
                <div class="relative max-w-4xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 grid-rows-1">
                        <template x-for="(testimonial, index) in testimonials" :key="index">
                            <div x-show="currentSlide === index" x-transition:enter="transition ease-out duration-500"
                                ...
                                {{-- Quote --}}
                                <p class="text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-8 italic"
                    ...
                    <div class="flex items-center justify-center gap-4 mt-8">
                        <button @click="prev()"
                            class="w-10 h-10 rounded-full border border-gray-200 dark:border-gray-700 flex items-center justify-center hover:bg-[#FFC72C] hover:border-[#FFC72C] hover:text-white transition-all duration-300">
            ...
            <div class="max-w-3xl mx-auto mt-20 lp-animate" x-intersect:enter.once="$el.classList.add('visible')">
                <div
                    class="bg-white dark:bg-[#222] rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-800 relative overflow-hidden">
                    {{-- Decorative bg --}}
                    <div
                        class="absolute -top-24 -right-24 w-48 h-48 bg-gradient-to-br from-[#FFC72C]/20 to-[#FF9500]/20 rounded-full blur-3xl">
                    </div>

                    <h3 class="text-2xl font-bold mb-2">Berikan Ulasan Anda</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm mb-6">Ceritakan pengalaman Anda menggunakan
                        produk Trifafarm.</p>

                    @if(session('success'))
                        <div
                            class="mb-6 p-4 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-xl flex items-center gap-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama" id="nama" required
                                    class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#1a1a1a] focus:bg-white dark:focus:bg-[#222] focus:ring-2 focus:ring-[#FFC72C] focus:border-transparent transition-all outline-none"
                                    placeholder="Cth: Budi Santoso">
                            </div>
                            <div>
                                <label for="role"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pekerjaan /
                                    Asal</label>
                                <input type="text" name="role" id="role"
                                    class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#1a1a1a] focus:bg-white dark:focus:bg-[#222] focus:ring-2 focus:ring-[#FFC72C] focus:border-transparent transition-all outline-none"
                                    placeholder="Cth: Pemilik RM Padang">
                            </div>
                        </div>
                        <div>
                            <label for="teks"
                            ...
                            <textarea name="teks" id="teks" rows="4" required
                                class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#1a1a1a] focus:bg-white dark:focus:bg-[#222] focus:ring-2 focus:ring-[#FFC72C] focus:border-transparent transition-all outline-none resize-none"
                                placeholder="Tuliskan pendapat Anda tentang produk kami..."></textarea>
                        </div>
                        <button type="submit"
                            class="w-full py-3.5 bg-[#FFC72C] hover:bg-[#FFB800] text-white font-bold rounded-xl shadow-lg shadow-[#FFC72C]/30 transition-all hover:scale-[1.02] active:scale-[0.98]">
                            Kirim Ulasan
                        </button>
                    </form>
                </div>
    ...
    <section class="py-20 md:py-28 relative overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-10"
            style="background-image: radial-gradient(circle at 20% 50%, white 1px, transparent 1px); background-size: 30px 30px;">
        </div>
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center lp-animate"
            x-intersect:enter.once="$el.classList.add('visible')">
            <div
                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 text-white text-sm font-medium mb-6">
            ...
            <p class="text-lg text-white/80 mb-10 max-w-2xl mx-auto">
                Hubungi kami langsung melalui WhatsApp untuk pemesanan cepat dan mudah. Tim sales kami siap membantu
                Anda.
            </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-5 space-y-8">
                    <div class="lp-animate" x-intersect:enter.once="$el.classList.add('visible')">
                        <span
                            class="inline-block px-4 py-1.5 rounded-full bg-[#FFC72C]/10 text-[#FFC72C] text-sm font-semibold mb-4">Hubungi
                            Kami</span>
                        ...
                        <p class="text-gray-500 dark:text-gray-400 leading-relaxed text-sm">
                            Punya pertanyaan tentang produk kami, kerja sama kemitraan, atau ingin berkunjung langsung?
                            Silakan hubungi kami atau kunjungi peternakan kami di Padang.
                        </p>
                    </div>
                    ...
                    <div class="space-y-4">
                        {{-- Address --}}
                        <div
                            class="flex items-start gap-4 p-5 rounded-2xl bg-white dark:bg-[#222] border border-gray-100 dark:border-gray-800 shadow-sm">
                            <div
                                class="w-10 h-10 rounded-xl bg-[#FFC72C]/10 flex items-center justify-center text-[#FFC72C] shrink-0">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
                                    RT 02 / RW 06, Koto Baru, Kel. Limau Manis Selatan, Kec. Pauh, Kota Padang, Sumatera
                                    Barat 25158
                                </p>
                            </div>
                        </div>
                        ...
                        {{-- Phone / WhatsApp --}}
                        <a href="https://wa.me/6281372237463?text=Halo%20Trifafarm,%20saya%20ingin%20bertanya%20mengenai%20produk%20Anda"
                            target="_blank"
                            ...
                            <div>
                                ...
                                <p class="text-xs text-green-600 dark:text-green-400 mt-1 font-semibold">+62
                                    813-7223-7463</p>
                            </div>
                        </a>
                    </div>
                ...
                <div class="lg:col-span-7 lp-animate" x-intersect:enter.once="$el.classList.add('visible')">
                    <div
                        class="relative rounded-3xl overflow-hidden shadow-xl shadow-black/5 dark:shadow-black/20 border border-gray-100 dark:border-gray-800 bg-white dark:bg-[#222] p-2">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1063.7588851441528!2d100.47769847296289!3d-0.9355222998593551!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2fd4b7001a50579d%3A0x2ebba61a6625b9b9!2sTRIFA%20FARM!5e1!3m2!1sid!2sid!4v1782149257375!5m2!1sid!2sid"
                            class="w-full h-96 rounded-2xl" style="border:0;" allowfullscreen="" loading="lazy"
    ...
    <footer class="bg-[#e9e9e9] dark:bg-[#111] py-12 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
                class="flex flex-col md:flex-row items-center justify-between gap-6 border-b border-gray-200 dark:border-gray-800 pb-8 mb-8">
                {{-- Logo --}}
                <div class="flex items-center gap-2">
                    <img src="{{ asset('images/trifaFarmRedesign.png') }}"
                        class="h-10 md:h-11 w-auto object-contain drop-shadow-md" alt="Trifafarm Logo">
                ...
                <div class="flex flex-wrap justify-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                    <a href="#beranda" @click.prevent="scrollToSection('beranda')"
                        class="hover:text-[#FFC72C] transition-colors">Beranda</a>
                    <a href="#produk" @click.prevent="scrollToSection('produk')"
                        class="hover:text-[#FFC72C] transition-colors">Produk</a>
                    <a href="#tentang" @click.prevent="scrollToSection('tentang')"
                        class="hover:text-[#FFC72C] transition-colors">Tentang Kami</a>
                    <a href="#testimoni" @click.prevent="scrollToSection('testimoni')"
                        class="hover:text-[#FFC72C] transition-colors">Testimoni</a>
                    <a href="#kontak" @click.prevent="scrollToSection('kontak')"
                        class="hover:text-[#FFC72C] transition-colors">Kontak</a>
                ...
                <div class="flex gap-3">
                    <a href="#"
                        class="w-8 h-8 rounded-lg bg-gray-200 dark:bg-gray-800 flex items-center justify-center hover:bg-[#FFC72C] hover:text-white transition-all duration-300 text-gray-500">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <p class="text-xs text-gray-400">Dibuat dengan <span class="text-[#FFC72C]">♥</span> untuk ketahanan
                    pangan Indonesia</p>
            </div>
        </div>
    </footer>
...
]) : json_encode($testimonis->map(function ($t) {
    return ['name' => $t->nama, 'role' => $t->role ?? 'Pelanggan', 'text' => $t->teks]; })) !!},
