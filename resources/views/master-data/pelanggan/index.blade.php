...
@section('content')
    ...
    <x-page-header title="Data Pelanggan" subtitle="Kelola data pelanggan dan pembeli">
        <x-slot:action>
            <x-button variant="primary" tag="a" href="{{ route('master-data.pelanggan.create') }}">
                ...
                <tr>
                    ...
                    <td class="px-4 py-3 text-sm">
                        <div class="flex items-center space-x-2">
                            <x-button variant="secondary" size="sm" tag="a" href="{{ route('master-data.pelanggan.edit', $pelanggan->id_pelanggan) }}">
