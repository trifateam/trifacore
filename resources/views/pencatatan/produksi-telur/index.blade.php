                                    ...
                                    @foreach($kandang['batches'] as $batch)
                                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border border-gray-100">
                                            ...
                                            <div class="mt-3 flex justify-end">
                                                ...
                                                @else
                                                    <a href="{{ route('pencatatan.produksi-telur.create', $batch['id_batch']) }}" class="block relative w-full">
                                                        <x-button variant="primary" size="sm" class="w-full justify-center relative">
                                                            ...
                                                            Catat Sekarang
                                                            <x-badge-notification :show="!$batch['sudah_tercatat']" class="absolute -top-1.5 -right-1.5" />
                                                        </x-button>
                                                    </a>
                                                @endif
                                            </div>
