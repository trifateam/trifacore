<aside x-data="sidebarManager()"
    ...
    <div class="w-20 bg-gray-900 border-r border-gray-800 flex flex-col items-center py-6 space-y-4 z-40 shrink-0">
        ...
        <a href="/dashboard" 
           ...
           :class="currentPage === 'dashboard' ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'text-gray-400 hover:text-amber-500 hover:bg-amber-500/10'">
        ...
        <button @mouseenter="handleIconHover('pencatatan', 'Pencatatan Harian')"
           ...
           :class="currentPage === 'pencatatan' ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'text-gray-400 hover:text-amber-500 hover:bg-amber-500/10'">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <button @mouseenter="handleIconHover('transaksi', 'Manajemen Transaksi')"
           ...
           class="w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-200 cursor-pointer"
           :class="currentPage === 'transaksi' ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'text-gray-400 hover:text-amber-500 hover:bg-amber-500/10'">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <button @mouseenter="handleIconHover('riwayat', 'Riwayat')"
           ...
           class="w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-200 cursor-pointer"
           :class="currentPage === 'riwayat' ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'text-gray-400 hover:text-amber-500 hover:bg-amber-500/10'">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <a href="/kandang-operasional"
           ...
           class="w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-200"
           :class="currentPage === 'kandang' ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'text-gray-400 hover:text-amber-500 hover:bg-amber-500/10'">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <a href="/gudang"
           ...
           class="w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-200"
           :class="currentPage === 'gudang' ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'text-gray-400 hover:text-amber-500 hover:bg-amber-500/10'">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <button @mouseenter="handleIconHover('masterData', 'Master Data')"
           ...
           class="w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-200 cursor-pointer"
           :class="currentPage === 'masterData' ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'text-gray-400 hover:text-amber-500 hover:bg-amber-500/10'">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <button @mouseenter="handleIconHover('keuangan', 'Management Keuangan')"
           ...
           class="w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-200 cursor-pointer"
           :class="currentPage === 'keuangan' ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'text-gray-400 hover:text-amber-500 hover:bg-amber-500/10'">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <button @mouseenter="handleIconHover('laporan', 'Laporan')"
           ...
           class="w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-200 cursor-pointer"
           :class="currentPage === 'laporan' ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'text-gray-400 hover:text-amber-500 hover:bg-amber-500/10'">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <button @mouseenter="handleIconHover('pengaturan', 'Pengaturan')"
           ...
           class="w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-200 cursor-pointer"
           :class="currentPage === 'pengaturan' ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'text-gray-400 hover:text-amber-500 hover:bg-amber-500/10'">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
...
<div x-data="mobileNav()" class="md:hidden">
    ...
    <nav class="fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 mobile-bottom-nav">
        <div class="flex items-center justify-around h-16 px-2">
            ...
            @role('Admin', 'Pegawai Kandang')
            {{-- Pencatatan (Admin, Pegawai Kandang) --}}
