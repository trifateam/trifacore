...
@php
    ...
    if ($hasError) {
        $inputClass = 'w-full rounded-lg border-red-500 dark:border-red-400 bg-white dark:bg-gray-700 focus:border-red-500 focus:ring-red-500 text-sm text-red-900 dark:text-red-300';
    }
