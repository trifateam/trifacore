...
<body class="bg-gray-100 dark:bg-gray-700 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md">
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg px-8 py-10">
            <h1 class="text-2xl font-bold text-center text-gray-800 dark:text-gray-200 mb-8">Login TriFaCore</h1>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex items-center mb-6">
                    <input type="checkbox" id="remember" name="remember"
                           class="h-4 w-4 text-blue-600 dark:text-blue-500 border-gray-300 dark:border-gray-600 rounded">
            ...
            <p class="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
                Belum punya akun?
                <a href="{{ route('register') }}" class="text-blue-600 dark:text-blue-500 hover:underline">Daftar</a>
            </p>
        </div>
    </div>
</body>
