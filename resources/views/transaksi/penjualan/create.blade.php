                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <x-card class="border border-gray-200">
                        ...
                        <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                <label for="id_pelanggan" class="block text-sm font-medium text-gray-700 mb-1">Pelanggan <span class="text-red-500">*</span></label>
                                <select name="id_pelanggan" id="id_pelanggan" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                ...
                                @error('id_pelanggan') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                            </div>

                            @if($jenis === 'afkir')
                                <div class="md:col-span-2">
                                    <label for="id_kandang" class="block text-sm font-medium text-gray-700 mb-1">Kandang Target (Sumber Ayam) <span class="text-red-500">*</span></label>
                                    <select name="id_kandang" id="id_kandang" required x-model="selectedKandang" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    ...
                                    @error('id_kandang') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                                </div>
                            @endif
                        </div>
                    </x-card>
                                ...
                                <tbody>
                                    <template x-for="(item, index) in items" :key="item.key">
                                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                            <td class="p-3">
                                                <select :name="`items[${index}][id_barang]`" x-model="item.id_barang" @change="updateItemLimit(index)" required class="w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="p-5">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select name="metode_pembayaran" id="metode_pembayaran" x-model="metodePembayaran" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm font-medium">
                                ...
                                <div x-show="metodePembayaran === 'LUNAS'" x-transition>
                                    <label for="id_akun_kas" class="block text-sm font-medium text-gray-700 mb-1">Rekening Tujuan (Masuk) <span class="text-red-500">*</span></label>
                                    <select name="id_akun_kas" id="id_akun_kas" :required="metodePembayaran === 'LUNAS'" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                ...
                                <div>
                                    ...
                                    <textarea name="catatan" id="catatan" rows="2" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('catatan') }}</textarea>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Penanggung Jawab</label>
                                    <input type="text" readonly value="{{ auth()->user()->nama_lengkap }}" class="w-full bg-gray-100 border-gray-300 rounded-md shadow-sm sm:text-sm text-gray-500 cursor-not-allowed">
                                </div>
                            </div>
                        </div>
