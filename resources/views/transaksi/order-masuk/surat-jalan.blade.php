...
<head>
    <meta charset="utf-8">
    <title>Surat Jalan - {{ $penjualan->no_faktur_jual }}</title>
    <style>
        ...
        .signature td { width: 33.33%; vertical-align: bottom; }
        .sign-line { display: inline-block; width: 160px; border-bottom: 1px solid #000; margin-top: 60px; margin-bottom: 5px; }
        .notes-box { margin-top: 10px; padding: 8px; border: 1px dashed #999; font-size: 11px; }
...
<body>
    ...
    <div class="title">
        <h2>Surat Jalan</h2>
        <p>No: {{ $penjualan->no_faktur_jual }}</p>
    </div>
    ...
    <p style="font-size: 11px;">Dengan ini kami kirimkan barang-barang tersebut di bawah ini:</p>
