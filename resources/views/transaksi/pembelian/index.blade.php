    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 max-w-4xl mx-auto">
        ...
        <a href="{{ route('transaksi.pembelian.create', ['jenis' => 'material']) }}" class="group block h-full">
            <x-card class="h-full flex flex-col items-center justify-center p-10 text-center border-2 border-transparent hover:border-blue-400 hover:shadow-xl transition-all duration-300 bg-gradient-to-b from-white to-blue-50">
                <div class="w-24 h-24 rounded-full bg-blue-100 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                    <span class="text-5xl">📦</span>
                </div>
                <h3 class="text-2xl font-bold text-gray-900 mb-3">Material Gudang</h3>
                <p class="text-gray-600">Beli Pakan, Vitamin, Obat, atau perlengkapan lainnya. Stok barang di gudang akan otomatis bertambah setelah transaksi berhasil.</p>
                <div class="mt-8 flex items-center text-blue-600 font-bold text-sm group-hover:translate-x-2 transition-transform duration-300 uppercase tracking-wider">
                    Buat Transaksi
        ...
        <a href="{{ route('transaksi.pembelian.create', ['jenis' => 'pullet']) }}" class="group block h-full">
            <x-card class="h-full flex flex-col items-center justify-center p-10 text-center border-2 border-transparent hover:border-orange-400 hover:shadow-xl transition-all duration-300 bg-gradient-to-b from-white to-orange-50">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-3">Pullet (Bibit Ayam)</h3>
                <p class="text-gray-600">Beli ayam muda (pullet) untuk populasi kandang. Akan otomatis membuat Batch baru dengan status "Pending" yang siap dimasukkan ke kandang.</p>
