            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <x-card class="border border-gray-200 dark:border-gray-700">
                        <div class="p-5 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
                            <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100">Informasi Supplier</h3>
                        </div>
                        <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                <label for="id_supplier" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Supplier <span class="text-red-500">*</span></label>
                                <select name="id_supplier" id="id_supplier" required class="w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    <option value="">-- Pilih Supplier --</option>
                                    @foreach($suppliers as $s)
                                        <option value="{{ $s->id_supplier }}" {{ old('id_supplier') == $s->id_supplier ? 'selected' : '' }}>
                                            {{ $s->nama_supplier }} ({{ $s->kontak_supplier ?? '-' }})
                                        </option>
                                    @endforeach
                                </select>
                                @error('id_supplier') <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p> @enderror
                            </div>
                        </div>
                    </x-card>
                    ...
                    <x-card class="border border-gray-200 dark:border-gray-700">
                        <div class="p-5 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50 flex justify-between items-center">
                            <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100">Daftar Barang Dibeli</h3>
                        ...
                        <div class="p-4 bg-blue-50 dark:bg-blue-900/30 border-t border-blue-100">
                            <p class="text-xs text-blue-700 dark:text-blue-400 font-medium flex items-center">
                ...
                <div class="space-y-6">
                    <x-card class="border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="p-5">
                            <div class="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg border border-blue-100 mb-6">
                                <h4 class="text-xs font-bold text-blue-800 dark:text-blue-300 uppercase tracking-wider mb-3">Total Pengeluaran</h4>
                                <div class="text-3xl font-bold text-blue-700 dark:text-blue-400" x-text="formatRupiah(grandTotal)">Rp 0</div>
                            </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select name="metode_pembayaran" id="metode_pembayaran" x-model="metodePembayaran" required class="w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm font-medium">
                                ...
                                <div x-show="metodePembayaran === 'LUNAS'" x-transition>
                                    <label for="id_akun_kas" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Rekening Sumber Dana <span class="text-red-500">*</span></label>
                                    <select name="id_akun_kas" id="id_akun_kas" :required="metodePembayaran === 'LUNAS'" class="w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                ...
                                <div x-show="metodePembayaran === 'TEMPO'" class="p-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-md" x-transition>
                                ...
                                <div>
                                    ...
                                    <textarea name="catatan" id="catatan" rows="2" class="w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">{{ old('catatan') }}</textarea>
                                </div>
                            </div>
                        </div>
